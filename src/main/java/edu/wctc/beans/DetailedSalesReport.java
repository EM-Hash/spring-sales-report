...
public class DetailedSalesReport implements ISalesReport {
    ...
    public void generateReport(List<Sale> salesList) {
        ...
        System.out.printf("|%20S|%15S|%7S|%7S|%9S|%n", headers[0], headers[1], headers[2], headers[3], headers[4]);
        System.out.println(tableBorder);
        for(Sale sale : salesList){
            System.out.printf("|%20s|%15s|$%6.2f|$%6.2f|$%8.2f|%n", sale.getCustomer(), sale.getCountry(), sale.getAmount(), sale.getTax(), sale.getShipping());
            System.out.println(tableBorder);
        }
    }
}
